    ...
    return (
      <div>
        <div className="footer-bg overflow-hidden text-white fw-light p-5">
          <h1 className="fs-1 text-center pb-3 text-warning">Hungry</h1>
          <div className="container">
            <div className="row">
              <div className="col-md-3 col-sm-12">
                <ul className="list-unstyled">
                  <li className="fw-bold banner-text">Help</li>
                  <li>Search</li>
                  <li>Information</li>
              ...
              <div className="col-md-3 col-sm-12">
                <ul className="list-unstyled">
                  <li className="fw-bold banner-text">Information</li>
                  <li>Search Terms</li>
              ...
              <div className="col-md-3 col-sm-12">
                <ul className="list-unstyled">
                  <li className="fw-bold banner-text">Contact Us</li>
                  <li>
              ...
              <div className="col-md-3 col-sm-12">
                <ul className="list-unstyled">
                  <li className="fw-bold">
                    Get special offers and more from Hungry
                  </li>
                </ul>
